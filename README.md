...
- **JavaScript** - Color generation and interactivity

## 📦 Installation

1. Clone the repository:
   ```bash
   git clone https://github.com/v33550336/random-color-generator.git
   ```
...
3. The HEX code will be displayed and updated automatically
